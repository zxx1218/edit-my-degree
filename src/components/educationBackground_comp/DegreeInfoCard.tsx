      ...
      <div className="p-8 flex gap-6 flex-1">
        ...
        <div className="flex-1 border-l border-gray-200 pl-8">
          <div className="grid grid-cols-2 gap-x-10 gap-y-6 text-sm">
            ...
            <div className="flex items-start">
              <span className="text-gray-400 w-20 text-right flex-shrink-0 mr-3 whitespace-nowrap">获学位日期：</span>
              <span className="text-gray-800 flex-1">{record.graduationDate || "2025年06月30日"}</span>
            </div>

            {/* 第3行 - 跨两列 */}
            <div className="flex items-start col-span-2">
              <span className="text-gray-400 w-20 text-right flex-shrink-0 mr-3 whitespace-nowrap">学位授予单位：</span>
              <span className="text-gray-800 flex-1">{record.school}</span>
            </div>

            {/* 第4行 */}
            <div className="flex items-start">
              <span className="text-gray-400 w-20 text-right flex-shrink-0 mr-3 whitespace-nowrap">所授学位：</span>
              <span className="text-gray-800 flex-1">{record.degreeType || "经济学学士学位"}</span>
            </div>
            <div className="flex items-start">
              <span className="text-gray-400 w-20 text-right flex-shrink-0 mr-3 whitespace-nowrap">学科/专业：</span>
              <span className="text-gray-800 flex-1">{record.major}</span>
            </div>

            {/* 第5行 - 跨两列 */}
            <div className="flex items-start col-span-2">
              <span className="text-gray-400 w-20 text-right flex-shrink-0 mr-3 whitespace-nowrap">学位证书编号：</span>
