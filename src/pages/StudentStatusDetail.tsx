          ...
          <div className="flex items-start gap-4 mb-3">
            ...
            <div className="flex gap-3">
              <div className="text-center">
                ...
                />
                <div
                  className="w-[60px] h-[80px] bg-white/20 rounded-[8px] mb-1 cursor-pointer hover:bg-white/30 transition-colors flex items-center justify-center overflow-hidden"
              ...
              <div className="text-center">
                ...
                />
                <div
                  className="w-[60px] h-[80px] bg-gray-300 rounded-[8px] mb-1 cursor-pointer hover:bg-gray-400 transition-colors flex items-center justify-center overflow-hidden relative"
