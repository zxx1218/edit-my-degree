  ...
  const videoConfig = {
    ...
    demo2: {
      ...
      instructions: [
        ...
        {
          number: "3",
          text: "每生成一份报告需消耗30个PDF积分，永久版用户会赠送30个积分，若需额外PDF积分充值请单独购买",
          isWarning: false,
        },
        {
          number: "4",
          text: "网页版建议使用电脑端访问，手机访问效果不佳，注意网页信息来源于您在主页设置的学籍学历学位以及考研信息卡片及其内容，请先设置好再登陆网页版查看",
          isWarning: false,
        },
        { number: "5", text: "特别注意：仅限娱乐！", isWarning: true },
      ],
    },
    demo3: {
      src: "ttt.mp4",
