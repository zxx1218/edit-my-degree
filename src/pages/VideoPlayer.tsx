  ...
  const videoConfig = {
    demo1: {
      ...
      instructions: [
        ...
        {
          number: "2",
          text: "单机具体卡片进入详情页可以修改个人信息，但上传的照片保存会比较慢，请等待系统弹出保存成功的提示",
          isWarning: false,
        },
        { number: "3", text: "系统没有登陆时间限制，能否登陆只看登录次数余额", isWarning: false },
        {
          number: "4",
          text: "上传照片请注意照片不要太大，过大的高清照片会导致您每次点击详情页面的等待加载时间延长",
          isWarning: false,
        },
        {
          number: "3",
    ...
    demo2: {
      ...
      instructions: [
        {
          number: "1",
          text: "生成PDF之前务必注意您填写的信息要准确，证件照上传请保持1:1.33的标准比例",
          isWarning: false,
        },
        {
          number: "2",
        ...
        {
          number: "4",
          text: "网页版学信档案建议使用电脑端访问，手机访问效果不佳，网页版信息来源于您在主页设置的个人信息，请先设置好在登陆网页版查看",
          isWarning: false,
        },
