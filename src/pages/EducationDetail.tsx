...
interface LongPressFieldProps {
  ...
  label: string;
  value: string;
  onLongPress: (field: keyof EducationData, label: string) => void;
}
...
const EducationDetail = () => {
  ...
  const handleImageUpload = async (e: React.ChangeEvent<HTMLInputElement>) => {
    ...
    try {
      ...
      try {
        await updateData("education", "update", userId, { photo: compressedPhotoData }, id);
  ...
  return (
    <div className="min-h-screen bg-background">
      ...
      <div className="p-4 bg-white min-h-screen">
        {/* Student Info Card */}
        <div className="bg-gradient-to-b from-[rgb(55,134,243)] to-[rgb(91,167,248)] rounded-[7px] p-5 text-white mb-6 shadow-[0px_4px_4px_3px_rgba(98,191,207,0.2)]">
